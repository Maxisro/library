...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.addAttribute = function (attrName, value) {
  for (let i = 0; i < this.length; i++) {
    this[i].setAttribute(attrName, value);
  }
  return this;
};
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.remAttribute = function (attrName) {
  for (let i = 0; i < this.length; i++) {
...
Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])("button").on("click", function () {
  Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])("div").eq(3).toggleClass("active");
});
